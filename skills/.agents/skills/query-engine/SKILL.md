---
name: query-engine
description: Nexora Engine's smart query system with automatic caching, deduplication, and TTL-based expiration. Provides a high-level cached query layer on top of Supabase with request deduplication and cache invalidation on mutations.
license: MIT
