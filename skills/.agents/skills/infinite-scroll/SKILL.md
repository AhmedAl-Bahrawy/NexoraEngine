...
description: Infinite scroll manager, cursor-based pagination, optimistic updates, and enhanced QueryBuilder capabilities for building performant, responsive data loading experiences.
license: MIT
